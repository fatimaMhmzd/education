    ...
    <div class="col-md-9 col-change">
        ...
        <div class="page-title p-3 mt-2" style="height: 56px">
            <div class="d-flex justify-content-between">
                ...
                <h6 class="text-start title-start d-md-block d-inline-block ps-md-1">سفارشات</h6>
                        ...
                        <div class="table-responsive">
                            <table class="qa-table table table-bordered border-primary mt-2"
                                ...
                                <tr class="font-14 text-75 text-center" style="background-color: #FFFBF5">
                                    ...
                                    <th class="border border-1 p-2 fw-normal">محصول</th>
                                    <th class="border border-1 p-2 fw-normal">شناسه محصول</th>
                                    <th class="border border-1 p-2 fw-normal">مبلغ(تومان)</th>
                                ...
                                <tr class="text-center font-12 text-46" style="background-color: #FFFBF5">
                                    ...
                                    <td class="border border-1 p-2">گفتگو و تغییر عقاید</td>
                                    <td class="border border-1 p-2">123544</td>
                                    <td class="border border-1 p-2">15,000,000</td>
                                    <td class="border border-1 p-2">1401/02/12</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-4">
                        <div class="collapse audio-collapse" id="audio-modal">
                            <div class="d-flex justify-content-between px-3 py-2"
                                ...
                                <p class="font-12">آموزش نحوه تنظیم سفارشات</p>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content container" style="box-shadow: none;background-color: #FDFEFF">
                            <div class="modal-header justify-content-center px-4 py-4"
                                ...
                                <h6 class="modal-title text-46" style="font-size: 24px">آموزش نحوه تنظیم سفارشات</h6>
                            </div>
...
@section('script')
    <script>
        ...
        getImage[5].className = 'img-fluid list-image p-3 li-active';
        getImage[12].className = 'img-fluid list-image p-3 li-active';
    </script>
@endsection
