...
{{--                                </select>--}}
{{--                            </div>--}}
                            <label class="form-label">2) مدت زمان دوره</label>
                            <div class="col-md-3 mt-md-0 mt-3">
                                <input type="text" class="form-control" name="length" placeholder="ساعت">
                            </div>
                            <div class="col-md-3 mt-md-0 mt-3">
                                <input type="text" class="form-control vertical-td" name="length" placeholder="دقیقه">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 32px">
                            ...
                            <div class="col-md-6">
                                ...
                                <input data-jdp class="form-control" name="start">
                            </div>
                            <div class="col-md-6 mt-md-0 mt-3">
                                <label class="form-label">تاریخ پایان</label>
                                <input data-jdp class="form-control" name="end">
                            </div>
                        </div>
                        <div class="row" style="margin-top: 32px">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="price" class="form-control text-center prices">
