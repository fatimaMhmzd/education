            ...
            <div class="row">
                ...
                <div class="col-1 list-li-sm py-3 ms-2" id="education-bar">
                    ...
                    <ul class="list-group list-unstyled mt-3">
                        ...
                        <div class="dropdown">
                            <li class="p-li list-group-item mb-2 border-0 dropdown-toggle" data-bs-toggle="dropdown">
                                <a href="#">
                                    ویرایش دوره
                                </a>
                            </li>
                            <ul class="dropdown-menu list-drop position-static" id="dropdown-open" style="height: 120px">
                                <li class="list-drop-li mb-3" style="margin-top: -50px !important;">
                                    <a class="dropdown-item font-12" href="{{route('education_master_course_update_firstStep',\Illuminate\Support\Facades\Session::get('courseId'))}}">
                                        <div class="d-flex">
                                            <img src="/indexImages/tickg.png" class="img-fluid me-2 project-bar-img" style="height: 20px;width: 20px">
                                            <span class="font-12" style="margin-top: 1px">
                                اطلاعات دوره
                            </span>
                                        </div>
                                    </a>
                                </li>
                                <li class="list-drop-li mb-3">
                                    <a class="dropdown-item font-12" href="{{route('education_master_course_update_secondStep',\Illuminate\Support\Facades\Session::get('courseId'))}}">
                                        <div class="d-flex">
                                            <img src="/indexImages/warningicon.png" class="img-fluid me-2 project-bar-img" style="height: 20px;width: 20px;border: 1px solid #FBBC3E">
                                            <span class="font-12" style="margin-top: 1px">
                                توضیحات دوره
                            </span>
                                        </div>
                                ...
                                <li class="list-drop-li mb-3">
                                    <a class="dropdown-item font-12" href="{{route('education_master_course_update_thirdStep',\Illuminate\Support\Facades\Session::get('courseId'))}}">
                                        <div class="d-flex">
                                            <img src="/indexImages/danger.png" class="img-fluid me-2 project-bar-img" style="height: 20px;width: 20px">
                                            <span class="font-12" style="margin-top: 1px">
                                محتوای دوره
                            </span>
                                        </div>
                        ...
                        <li class="p-li list-group-item mb-2 border-0">
                            <a href="{{--{{route('education_master_course_qa_index',\Illuminate\Support\Facades\Session::get('courseId'))}}--}}">
                                پرسش و پاسخ‌ها
                            </a>
                        </li>
                    </ul>
