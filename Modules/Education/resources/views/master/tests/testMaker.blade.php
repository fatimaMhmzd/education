    ...
    <div class="col-md-9 col-change">
        ...
        <div class="page-title p-3 mt-2" style="height: 56px">
            <div class="d-flex justify-content-between">
                ...
                <h6 class="text-start title-start d-md-block d-inline-block ps-md-1">ایجاد آزمون</h6>
        ...
        <div class="card information-card rounded-0 table-yellow" style="background-color: #FFFBF5">
            <div class="card-body mt-3 mb-3">
                <div class="row">
                   <div class="col-12">
                       <label class="form-label">آزمون دوره خود را ایجاد کنید</label>
                       <textarea name="testMaker"></textarea>
                   </div>
                    <div class="d-flex justify-content-center" style="margin-top: 32px">
                        <button class="btn px-4" type="submit" style="background-color:#F050AE ;height: 56px;color:#FDFEFF ">ذخیره</button>
                    </div>
                </div>
                {{--  helper --}}
                    ...
                    <div class="col-4">
                        <div class="collapse audio-collapse" id="audio-modal">
                            <div class="d-flex justify-content-between px-3 py-2"
                                ...
                                <p class="font-12">آموزش نحوه تنظیم ایجاد آزمون</p>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content container" style="box-shadow: none;background-color: #FDFEFF">
                            <div class="modal-header justify-content-center px-4 py-4"
                                ...
                                <h6 class="modal-title text-46" style="font-size: 24px">آموزش نحوه تنظیم ایجاد آزمون</h6>
                            </div>
