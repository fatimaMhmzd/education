    ...
    <div class="content-body">
        <section id="basic-input">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">ویرایش استاد</h4></div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{route('admin_education_master_storeUpdate')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                            <fieldset class="form-group"><label for="title">عنوان</label>
                                                <input type="text" class="form-control" id="title"
                                                       placeholder="عنوان" name="title" value="{{$educationMaster->title}}"></fieldset>
                                        </div>
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea type="text" name="description"
                                                          class="form-control"
                                                          id="description">{{$educationMaster->description}}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea type="text" name="rezome"
                                                          class="form-control"
                                                          id="rezome">{{$educationMaster->rezome}}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                            <fieldset class="form-group"><label for="seoKeyboard">لغات کلیدی</label>
                                                <textarea placeholder="لغات کلیدی" name="seoKeyboard"
                                                          class="form-control" id="seoKeyboard">{{$educationMaster->seoKeyboard}}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                            <fieldset class="form-group"><label for="seoDescription">توضیحات سئو</label>
                                                <textarea placeholder="توضیحات سئو" name="seoDescription"
                                                          class="form-control" id="seoDescription">{{$educationMaster->seoDescription}}</textarea>
                                            </fieldset>
                                        </div>
                                        <input name="id" value="{{$educationMaster->id}}" style="display: none">
