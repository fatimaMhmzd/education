    ...
    <div class="content-body">
        <section id="basic-input">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">افزودن فصل آموزشی</h4></div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{route('admin_education_session_store')}}" enctype="multipart/form-data">
                                    @csrf
