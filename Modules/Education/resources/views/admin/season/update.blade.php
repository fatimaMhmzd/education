    ...
    <div class="content-body">
        <section id="basic-input">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">ویرایش فصل</h4></div>
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{route('admin_education_session_storeUpdate')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                            <fieldset class="form-group"><label for="title">عنوان</label>
                                                <input type="text" class="form-control" id="title" value="{{$season->title}}"
                                                       placeholder="عنوان" name="title"></fieldset>
                                        </div>
                                        <div class="col-xl-6 col-md-12 col-12 mb-1">
                                            <fieldset class="form-group"><label for="subject">موضوع</label>
                                                <textarea placeholder="موضوع" name="subject" value="{{$season->subject}}"
