                    ...
                    @else
                        ...
                        @elseif($part->part->element_type_id == 5 )
                            <section id="business" class="mt-5 container">
                                <div class="title-box d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{route('business_index')}}" class="text-site text-decoration-none fw-bold font-14">
                                        مشاهده همه
                                        <i class="ti ti-chevron-left align-middle"></i>
                                    </a>
                                </div>
                                    ...
                                    <div class="swiper position-relative w-100" id="business-slider">
                                        <div class="swiper-wrapper">
                                            @foreach($busineses as $busines)
                                                <div class="swiper-slide">
                                                    <x-business-cart id="{{$busines->id}}"></x-business-cart>
                                               {{--     <div class="project-card mb-4">
                                                        <div class="card-front card content-card shadow">
                                                            <div class="card-image position-relative">
                                                                <img
                                                                    src="/{{$busines->banner->url ?? '/sources/image/project.jpg'}}"
                                                                    alt="project_img"
                                                                    class="image-fullscreen project_img">
                                                                <div
                                                                    class="position-absolute top-0 start-0 text-center">
                                                                ...
                                                                <div class="position-absolute bottom-0 end-0 text-end">
                                                                    <p class="detail-box-reverse w-auto mb-1 bg-orange mb-0 px-3 pe-4 py-2 font-10 text-white">
                                                                        {{$busines->SocialCommitment?->title}}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="card-body">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <img alt="profile"
                                                                             src="{{$busines->logo->url ?? '/default.jpg'}}"
                                                        ...
                                                        <span class="fw-bold">
                                                            ...
                                                            محل استقرار
                                                                                ...
                                                                                <span>{{$busines->province?->title}}/ {{$busines->town?->title}}</span>
                                                                            </div>
                                                                        </li>
                                                                        <li class="list-group-item border-0 border-bottom px-0">
                                                                            <div
                                                        ...
                                                        <span class="fw-bold">
                                                            ...
                                                            تعداد پروژه های ثبتی
                                                                                ...
                                                                                <span> {{$busines->projects_count}} پروژه</span>
                                                                            </div>
                                                                        </li>
                                                      ...
                                                      <span class="fw-bold">
                                                         ...
                                                         مبلغ جمع آوری شده
                                                                                ...
                                                                                <span>
                                                           <span class="price">{{\Modules\Business\Entities\Business::businesMoneyAmount($busines->id)}}</span>
                                                         تومان
                                                        </span>
                                                                            </div>
                                                                        </li>
                                ...
                                <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-image">
                                                    <a href="{{route('project_detail',$barjastes->id)}}">
                                                        @if($barjastes->image)
                                                            <img src="{{$barjastes->banner->url}}" alt="project"
                                    ...
                                    <div class="col-lg-7 mt-lg-0 mt-4">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="card-image">
                                                            <a href="{{route('project_detail',$item->id)}}">
                                                                @if($item->banner)
                                                                    <img alt="small" src="{{$item->banner->url}}"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-md-4 mt-1">
                                            {{ $tosies->links('pagination::bootstrap-4') }}
                                        </div>
                                    </div>
                                </div>
                            </section>
                        @elseif($part->part->element_type_id == 7 )
                            <section id="nahad" class="mt-5 container">
                                <div class="title-box d-flex justify-content-between align-items-center">
                                    <h2 class="h4 card-title fw-bold text-center mb-0">نهادهای اجتماعی فعال</h2>
                                    <a href="{{route('institution_index')}}"
                                       class="text-site text-decoration-none fw-bold font-14">
                                        مشاهده همه
                                        <i class="ti ti-chevron-left align-middle"></i>
                                    </a>
                                    ...
                                    <div class="swiper position-relative w-100" id="nahad-slider">
                                        <div class="swiper-wrapper">
                                            @foreach($institutions as $item)
                                                <div class="swiper-slide">
                                                    <x-nahad-cart id="{{$item->id}}"></x-nahad-cart>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="swiper-pagination position-relative mt-4"></div>
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="{{route('blog_detail' , $blog->slug)}}">
                                                        <div class="card pb-3 news-item"
                                                             style="background-image: url('/{{$blog->Image->url ?? 'sources/image/Rectangle%202705.png'}}')">
                                                            <div class="card-body">
        ...
        @else
            ...
            <section id="detail" class="container mt-5">
                <div class="row align-items-center">
                    <div class="col-lg-6 text-end">
                        <img
                            src="{{asset('/sources/image/detail.png')}}"
                            alt="detail" loading="lazy"
                            class="img-fluid w-100">
                    </div>
                    <div class="col-lg-6">
                        <div class="text-of-detail">
                            <h1 class="card-title h4 fw-bold">
                                کارماران
                            </h1>
                            <p class="card-text mt-3">
            ...
            <section id="second-detail" class="mt-5 container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1 order-0 text-start">
                        <img
                            src="{{asset('/sources/image/bg-2.png')}}"
                            alt="detail" loading="lazy" class="img-fluid w-100">
                    </div>
                </div>
            </section>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="project-items mt-3">
                                        ...
                                        <p class="font-14 mt-3 mb-1 text-muted">{{$barjastes->percent}} % تامین مالی
                                            شده</p>
                                        <div class="progress">
                                            <div class="progress-bar progress-card">
                                                <div class="blinder">
            ...
            <section id="lesson" class="mt-5 container">
                <div class="lesson-banner">
                    <div class="row align-items-center h-100">
                        <div class="col-md-5">
                            <h5 class="card-title h4 text-white fw-bold">
                                کارماران
                            </h5>
                            <p class="card-text text-white mt-3">
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
            ...
            <section id="blogs" class="mt-5 container">
                ...
                <div class="slider position-relative">
                    <div class="swiper blog-slider position-relative w-100 mt-4">
                        <div class="swiper-wrapper" id="blog-container">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: "https://blog.karmarun.ir/api/v1/blog/home",
                method: 'GET',
                        ...
                        <a href="/blog_detail/${blog.id}">
                            <div class="swiper-slide">
                                <div class="card news-item"
                                     style="background-image: url('${blog.Image ? blog.Image.url : '/sources/image/Rectangle 2698.png'}')">
                                    <div class="card-body">
                                        <p class="h6 text-white text-line fw-bold border-0 border-bottom border-white pb-3">
                                            ${blog.title}
                                        </p>
                                        <div class="d-flex w-100 justify-content-between align-items-center text-white font-14 mt-3">
                                            <div>
