...
<head>
    ...
    <link href="{{ asset('dashboard/app-assets/images/fonts.googleapis.css') }}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('dashboard/app-assets/css-rtl/core/colors/palette-gradient.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css-rtl/plugins/tour/tour.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('dashboard/app-assets/vendors/css/extensions/toastr.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('dashboard/app-assets/css-rtl/plugins/extensions/toastr.min.css')}}">
    ...
    <script src='{{asset('dashboard/app-assets/js/jquery.min.js')}}'></script>
...
<script src="{{ asset('dashboard/app-assets/js/scripts/extensions/sweet-alerts.min.js')}}"></script>

<script
    src="{{ asset('dashboard/ckeditor/ckeditor.js')}}"></script>


<script>
    $('textarea.ckeditor-textarea').each(function () {
                    ...
                    $.each(keys, function (index, key) {
                        ...
                        if (textarea.length) {
                            ...
                            if (CKEDITOR.instances[textarea.attr('id')]) {
                                CKEDITOR.instances[textarea.attr('id')].setData(data.object[key]);
                            } else {
                                textarea.val(data.object[key]);
                            }
                        }
...
<script>
    function resetForm() {
        ...
        // ریست کردن CKEditor ها داخل فرم
        $('#form textarea').each(function() {
