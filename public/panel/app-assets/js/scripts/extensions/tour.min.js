$(document).ready(function () {
    ...
    function e() {
        window.resizeEvt, 576 < $(window).width() ? $("#tour").on("click", function () {
    ...
    t.addStep("step-1", {
        ...
        buttons: [{text: "Skip", action: t.complete}, {text: "Next", action: t.next}]
    }), t.addStep("step-2", {
        text: "Check your notifications from here.",
        attachTo: ".dropdown-notification .icon-bell bottom",
        buttons: [{text: "Skip", action: t.complete}, {text: "previous", action: t.back}, {
            text: "Next",
            action: t.next
        }]
    }), t.addStep("step-3", {
