$(window).on("load", function () {
    ...
    p.addStep("step-1", {
        ...
        buttons: [{text: "Skip", action: p.complete}, {text: "Next", action: p.next}]
    }), p.addStep("step-2", {
        text: "Create your own bookmarks. You can also re-arrange them using drag & drop.",
        attachTo: ".bookmark-icons .icon-mail bottom",
        buttons: [{text: "Skip", action: p.complete}, {text: "previous", action: p.back}, {
            text: "Next",
            action: p.next
        }]
    }), p.addStep("step-3", {
        ...
        buttons: [{text: "previous", action: p.back}, {text: "Finish", action: p.complete}]
