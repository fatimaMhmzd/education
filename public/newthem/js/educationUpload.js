    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', { class: 'image-uploader' }),
                ...
                $i = $('<img>', { src: '/indexImages/educationDetail/gallery.png', class: 'text-center' }).appendTo($textContainer),
                $p = $('<p>', { text: 'آپلود تمرین (عکس، ویدئو، فایل، ...)' }).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', { class: 'uploaded-image' }),
                ...
                // Create the img tag
                $img = $('<embed>', { src: src }).appendTo($container),
