...
return [
    'messages' => [
        ...
        # list_type
        'list_type_success' => 'داده مورد نظر با موفقیت یافت شد',
        'list_type_failed' => 'خطایی رخ داد و داده یافت نشد',
    ],
    'fields' => [
        'id' => 'شناسه جدول یادآوری',
        'reminderable_type' => 'نام مدل رابط',
        'reminderable_id' => 'شناسه مدل رابط',
        'title' => 'عنوان',
        'description' => 'توضیحات',
        'date_time' => 'تاریخ و زمان',
        'type' => 'نوع تکرار',
        'number_repetition' => 'تعداد تکرار',
