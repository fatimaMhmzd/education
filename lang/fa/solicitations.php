...
return [
    'messages' => [
        ...
        # set_advertise
        'set_advertise_success' => 'داده ی مورد نظر با موفقیت همگام سازی شد',
        'set_market_success' => 'داده ی مورد نظر با موفقیت همگام سازی شد',
        'set_advertise_failed' => 'خطایی رخ داد و همگام سازی انجام نشد',
        'set_market_failed' => 'خطایی رخ داد و همگام سازی انجام نشد',
    ],
    'fields' => [
        ...
        'advertise_ids' => 'لیست شناسه های جدول آگهی',
    ]
