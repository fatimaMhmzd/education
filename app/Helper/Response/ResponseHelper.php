...
class ResponseHelper
{
    ...
    {
        if (empty($errors)) {
            $errors = ["message" => [trans("exceptions.exceptionErrors.unauthenticated")]];
        }
     ...
     * @return JsonResponse
     */
    public static function responseAccessDeniedErrorException(array|object $object = [], array|object $errors = null, string $message = "", int $statusCode = Response::HTTP_UNPROCESSABLE_ENTITY): JsonResponse
    {
        if (empty($errors)) {
            $errors = $message != null ? ["message" => [$message]] : ["message" => [trans("exceptions.exceptionErrors.accessDenied")]];
        }
        return self::responseError($object, $errors !== null ? $errors : new \stdClass(), $message, $statusCode);
    }
    ...
    {
        if (empty($errors)) {
            $errors = ["message" => [trans("exceptions.exceptionErrors.notFound")]];
        }
        return self::responseError($object, $errors !== null ? $errors : new \stdClass(), $message, $statusCode);
    }
    ...
    {
        if (empty($message) || (is_string($message) && !filled($message))) {
            $message = trans("exceptions.exceptionErrors.internalServerError");
        }
        if (empty($errors)) {
            $errors = ["message" => [trans("exceptions.exceptionErrors.internalServerError")]];
        }
        return self::responseError($object, $errors !== null ? $errors : new \stdClass(), $message, $statusCode);
    }
     ...
     * @return JsonResponse
     */
    public static function responseSuccessList(array|object $object=[], array|object $errors = [], string $message = "", int $statusCode = Response::HTTP_OK): JsonResponse
    {
        $object = ["data" => $object];
